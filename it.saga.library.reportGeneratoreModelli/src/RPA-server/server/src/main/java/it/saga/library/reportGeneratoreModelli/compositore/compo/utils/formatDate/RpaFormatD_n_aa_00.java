...
public class RpaFormatD_n_aa_00 extends RpaFormatDate {

    private String stringValue;
    private String stringFormatted;

    public RpaFormatD_n_aa_00(RpaMainCompositore mainCompositore, String stringValue) {
    ...
    private void formatValue() {
        ...
        if (date != null) {
            ...
            stringFormatted = dayString + " " + monthString;
