...
public class RpaInvalidFormatLimitsException extends RpaComposerException {

    public RpaInvalidFormatLimitsException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.INVALID_FORMAT_LIMITS;
