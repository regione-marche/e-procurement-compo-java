...
public class RpaFormatD_0_nn_0nI extends RpaFormatDate {

    private String stringValue;
    private String stringFormatted;

    public RpaFormatD_0_nn_0nI(RpaMainCompositore mainCompositore, String stringValue) {
    ...
    private void formatValue() {
        ...
        if (date != null) {
            ...
            // Riformatto la data
            DateFormat newDateFormat = new SimpleDateFormat("yyMM");
