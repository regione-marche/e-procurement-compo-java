...
public class RpaInvalidMnemonicIndexException extends RpaComposerException {

    public RpaInvalidMnemonicIndexException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.INVALID_MNEMONIC_INDEX;
