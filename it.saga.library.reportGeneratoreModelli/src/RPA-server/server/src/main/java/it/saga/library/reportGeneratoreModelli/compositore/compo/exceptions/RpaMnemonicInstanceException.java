...
public class RpaMnemonicInstanceException extends RpaComposerException {

    public RpaMnemonicInstanceException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.WRONG_MNEMONIC_INSTANCE;
