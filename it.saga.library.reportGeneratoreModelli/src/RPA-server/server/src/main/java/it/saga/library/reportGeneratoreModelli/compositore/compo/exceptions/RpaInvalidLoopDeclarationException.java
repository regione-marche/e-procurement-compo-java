...
public class RpaInvalidLoopDeclarationException extends RpaComposerException {

    public RpaInvalidLoopDeclarationException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.INVALID_DECLARATION_LOOP;
