...
public class RpaFormatD_n_nn_0nU extends RpaFormatDate {

    private String stringValue;
    private String stringFormatted;

    public RpaFormatD_n_nn_0nU(RpaMainCompositore mainCompositore, String stringValue) {
    ...
    private void formatValue() {
        ...
        if (date != null) {
            ...
            // Riformatto la data
            DateFormat newDateFormat = new SimpleDateFormat("MMddyy");
