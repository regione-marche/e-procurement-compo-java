...
public class RpaTextConversionFailException extends RpaComposerException {

    public RpaTextConversionFailException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.CONVERSION_FAIL_TEXT;
