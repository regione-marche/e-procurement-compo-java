...
public class RpaIncludemodException extends RpaComposerException {

    public RpaIncludemodException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.INCLUDEMOD_IMPORT_ERROR;
