...
public class RpaFormatXOra extends RpaFormatDate {

    private static final String TIMESTAMP_FORMAT_STRING = "HH";

    private String  stringValue;
    private String  stringFormatted;

    public RpaFormatXOra(RpaMainCompositore mainCompositore, String stringValue) {
