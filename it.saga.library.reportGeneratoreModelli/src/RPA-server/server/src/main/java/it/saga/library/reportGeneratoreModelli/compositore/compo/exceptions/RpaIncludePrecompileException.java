...
public class RpaIncludePrecompileException extends RpaComposerException {

    public RpaIncludePrecompileException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.PRECOMPILE_INCLUDE_ERROR;
