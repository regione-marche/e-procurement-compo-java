...
public class RpaJoinFailException extends RpaComposerException {

    public RpaJoinFailException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
