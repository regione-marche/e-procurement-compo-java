...
public class RpaFormatD_n_nn_nnU extends RpaFormatDate {

    private String stringValue;
    private String stringFormatted;

    public RpaFormatD_n_nn_nnU(RpaMainCompositore mainCompositore, String stringValue) {
    ...
    private void formatValue() {
        ...
        if (date != null) {
            ...
            // Riformatto la data
            DateFormat newDateFormat = new SimpleDateFormat("MMddyyyy");
