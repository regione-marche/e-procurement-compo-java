...
public class RpaUpdateMnemonicEntityDataIndexException extends RpaComposerException {

    public RpaUpdateMnemonicEntityDataIndexException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.NO_MNEMONIC_ENTITY_DATA_INDEX_TO_UPDATE;
