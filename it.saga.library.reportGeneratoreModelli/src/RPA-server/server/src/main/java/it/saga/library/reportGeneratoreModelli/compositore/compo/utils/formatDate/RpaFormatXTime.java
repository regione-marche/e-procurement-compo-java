...
public class RpaFormatXTime extends RpaFormatDate {

    private static final String TIMESTAMP_FORMAT_STRING = "HH:mm";

    private String  stringValue;
    private String  stringFormatted;

    public RpaFormatXTime(RpaMainCompositore mainCompositore, String stringValue) {
    ...
    private void formatValue() {
        ...
        if (stringValue != null) {
            ...
            // Formatto il valore a "ore:minuti"
