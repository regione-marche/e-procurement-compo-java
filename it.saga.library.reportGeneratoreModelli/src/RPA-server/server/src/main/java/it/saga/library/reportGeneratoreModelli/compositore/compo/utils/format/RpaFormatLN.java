...
public class RpaFormatLN extends RpaFormat {

    private Double  value;
    private String  formattedValue;

    public RpaFormatLN(RpaMainCompositore mainCompositore, Double value) {
    ...
    public RpaFormatLN(RpaMainCompositore mainCompositore, Integer value) {
    ...
    public RpaFormatLN(RpaMainCompositore mainCompositore, String value) throws ParseException {
    ...
    public void formatValue() {
        ...
        Double      roundDouble = bigDecimal.doubleValue();

        // Formatto e salvo la parte intera
        formattedValue = RpaNumberUtils.wordTranslate(roundDouble);
