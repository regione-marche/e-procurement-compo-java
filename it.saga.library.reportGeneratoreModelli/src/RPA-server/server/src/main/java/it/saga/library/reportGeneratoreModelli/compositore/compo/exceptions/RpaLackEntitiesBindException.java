...
public class RpaLackEntitiesBindException extends RpaComposerException {

    public RpaLackEntitiesBindException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.LACK_ENTITIES_BIND;
