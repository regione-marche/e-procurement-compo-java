...
public class RpaFormatD_0_nn_nnI extends RpaFormatDate {

    private String stringValue;
    private String stringFormatted;

    public RpaFormatD_0_nn_nnI(RpaMainCompositore mainCompositore, String stringValue) {
    ...
    private void formatValue() {
        ...
        if (date != null) {
            ...
            // Riformatto la data
            DateFormat newDateFormat = new SimpleDateFormat("yyyyMM");
