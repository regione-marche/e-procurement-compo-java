...
public class RpaMalformedOptionsDeclarationException extends RpaComposerException {

    public RpaMalformedOptionsDeclarationException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.MALFORMED_OPTIONS_DECLARATION;
