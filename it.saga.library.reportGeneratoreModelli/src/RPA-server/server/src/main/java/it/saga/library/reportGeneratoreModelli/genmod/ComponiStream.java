...
public class ComponiStream  implements java.io.Serializable {
    private java.lang.String nomeModello;

    private byte[] contenutoModello;
    ...
    public ComponiStream() {
    }

    public ComponiStream(
           java.lang.String nomeModello,
           byte[] contenutoModello,
           ...
           this.contenutoModello = contenutoModello;
           this.entita = entita;
    ...
    /**
     * Gets the nomeModello value for this ComponiStream.
     * 
     * @return nomeModello
     */
    ...
    /**
     * Sets the nomeModello value for this ComponiStream.
     * 
     * @param nomeModello
     */
    ...
    /**
     * Gets the contenutoModello value for this ComponiStream.
     * 
     * @return contenutoModello
     */
    public byte[] getContenutoModello() {
        return contenutoModello;
    }


    /**
     * Sets the contenutoModello value for this ComponiStream.
     * 
     * @param contenutoModello
     */
    public void setContenutoModello(byte[] contenutoModello) {
        this.contenutoModello = contenutoModello;
    }


    /**
     * Gets the entita value for this ComponiStream.
     * 
     * @return entita
     */
    ...
    /**
     * Sets the entita value for this ComponiStream.
     * 
     * @param entita
     */
    ...
    /**
     * Gets the elencoChiavi value for this ComponiStream.
     * 
     * @return elencoChiavi
     */
    ...
    /**
     * Sets the elencoChiavi value for this ComponiStream.
     * 
     * @param elencoChiavi
     */
    ...
    /**
     * Gets the valoriChiavi value for this ComponiStream.
     * 
     * @return valoriChiavi
     */
    ...
    /**
     * Sets the valoriChiavi value for this ComponiStream.
     * 
     * @param valoriChiavi
     */
    ...
    /**
     * Gets the idApplicazione value for this ComponiStream.
     * 
    ...
    /**
     * Sets the idApplicazione value for this ComponiStream.
     * 
    ...
    /**
     * Gets the codiceApplicazione value for this ComponiStream.
     * 
    ...
    /**
     * Sets the codiceApplicazione value for this ComponiStream.
     * 
    ...
    /**
     * Gets the registri value for this ComponiStream.
     * 
     * @return registri
     */
    ...
    /**
     * Sets the registri value for this ComponiStream.
     * 
     * @param registri
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ComponiStream)) return false;
        ComponiStream other = (ComponiStream) obj;
        ...
        _equals = true && 
            ...
            ((this.contenutoModello==null && other.getContenutoModello()==null) || 
             (this.contenutoModello!=null &&
              java.util.Arrays.equals(this.contenutoModello, other.getContenutoModello()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getContenutoModello() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getContenutoModello());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getContenutoModello(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ComponiStream.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://genmod.bl.gene.eldasoft.it", ">componiStream"));
        ...
        elemField.setFieldName("contenutoModello");
        elemField.setXmlName(new javax.xml.namespace.QName("http://genmod.bl.gene.eldasoft.it", "contenutoModello"));
