...
public class RpaFormatD_0_aa_aa extends RpaFormatDate {

    private String stringValue;
    private String stringFormatted;

    public RpaFormatD_0_aa_aa(RpaMainCompositore mainCompositore, String stringValue) {
    ...
    private void formatValue() {
        ...
        if (date != null) {
            ...
            String  yearString  = RpaNumberUtils.wordTranslate(year);

            // Creo e salvo la nuova data formattata
            stringFormatted = monthString + " " + yearString;
