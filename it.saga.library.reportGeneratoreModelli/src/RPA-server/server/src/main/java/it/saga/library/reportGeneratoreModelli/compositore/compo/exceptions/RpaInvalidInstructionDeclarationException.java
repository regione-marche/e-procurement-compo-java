...
public class RpaInvalidInstructionDeclarationException extends RpaComposerException {

    public RpaInvalidInstructionDeclarationException(RpaComposerConfiguration composerConfiguration, RpaANTLRErrorListener antlrErrorListener, int context, String code, String message) {
    ...
    public RpaErrorType getType() {
        ...
        return RpaErrorType.INVALID_DECLARATION_INSTRUCTION;
